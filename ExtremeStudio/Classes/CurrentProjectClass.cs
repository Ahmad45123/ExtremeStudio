...
namespace ExtremeStudio.Classes
{
    public class CurrentProjectClass
    {
        ...
        public static readonly string ApplicationFiles = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "/ExtremeStudio";
        ...
        public void ReadInfo()
        {
            ...
            {
                ObjectExplorerItems.Add(new ObjectExplorerItem(row[0].ToString(), row[1].ToString()));
            }
        }
        ...
        public void CopyGlobalConfig()
        {
            ...
            File.Copy(ApplicationFiles + "/configs/themeInfo.json",
                ProjectPath + "/configs/themeInfo.json", true);
            File.Copy(ApplicationFiles + "/configs/compiler.json",
                ProjectPath + "/configs/compiler.json", true);
        }
        ...
        public void EditSampConfig(string key, string value)
        {
            ...
            //Writing
            File.WriteAllText(ProjectPath + "/server.cfg", allText, Encoding.UTF8);
        }
